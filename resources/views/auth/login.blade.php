...
<head>
    ...
    <title>Giriş Yap — {{ config('app.name', 'Sadece Fanlar') }}</title>
...
<body class="d-flex flex-column" style="min-height:100vh;align-items:center;justify-content:center;">
    <div style="width:100%;max-width:400px;padding:2rem;">
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-muted mt-1" style="font-size:0.875rem;">Hesabına giriş yap</p>
        </div>
        ...
        <form method="POST" action="/login" style="display:flex;flex-direction:column;gap:1rem;">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email') }}" class="sf-input mt-1" required autofocus />
            </div>
            <div>
            ...
            <label class="d-flex align-items-center gap-2 pointer-cursor">
                <input type="checkbox" name="remember" style="accent-color:#d946ef;" />
                <span style="font-size:0.75rem;color:#cbd5e1;">Beni hatırla</span>
            </label>
            <button type="submit" class="btn btn-primary" style="width:100%;padding:0.75rem;font-size:0.875rem;">Giriş Yap</button>
        </form>

        <p class="text-center mt-3" style="font-size:0.75rem;color:#94a3b8;">
            Hesabın yok mu? <a href="/register" style="color:#d946ef;text-decoration:underline;">Kayıt Ol</a>
        </p>
    </div>
</body>
</html>
